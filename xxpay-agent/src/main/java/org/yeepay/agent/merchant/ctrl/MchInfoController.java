package org.yeepay.agent.merchant.ctrl;
...
public class MchInfoController extends BaseController {
    ...
    public ResponseEntity<?> get(HttpServletRequest request) {
        ...
        return ResponseEntity.ok(YeePayResponse.buildSuccess(rpcCommonService.rpcMchInfoService.find(mchInfo)));
    }
    ...
    public ResponseEntity<?> accountGet(HttpServletRequest request) {
        ...
        return ResponseEntity.ok(YeePayResponse.buildSuccess(mchAccount));
    }
