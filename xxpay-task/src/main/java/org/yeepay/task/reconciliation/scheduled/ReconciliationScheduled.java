package org.yeepay.task.reconciliation.scheduled;
...
import org.yeepay.task.reconciliation.channel.BillInterface;
import org.yeepay.task.reconciliation.entity.ReconciliationEntity;
import org.yeepay.task.reconciliation.service.ReconciliationService;
import org.yeepay.task.reconciliation.util.SpringUtil;
...
public class ReconciliationScheduled {
    ...
    public void settDailyCollectTask() {
        ...
        for(Channel channel : channelList) {
            ...
            if(YeePayUtil.isSuccess(retObj)) {
