...
public class OpenController {
    ...
    public String open(@RequestParam String params) {
        ...
        try {
            ...
            if(userObj == null) return YeePayUtil.makeRetFail(YeePayUtil.makeRetMap(PayConstant.RETURN_VALUE_FAIL, "支付中心开户失败", null, PayEnum.ERR_0010.getCode(), "开户失败"));
            ...
            if(result != 1) {
                return YeePayUtil.makeRetFail(YeePayUtil.makeRetMap(PayConstant.RETURN_VALUE_FAIL, "支付中心开户失败", null, PayEnum.ERR_0010.getCode(), "DB插入账户记录失败"));
            }
