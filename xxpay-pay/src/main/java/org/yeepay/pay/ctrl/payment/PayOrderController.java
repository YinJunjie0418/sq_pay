...
import org.yeepay.core.common.vo.OrderCostFeeVO;
...
public class PayOrderController extends BaseController {
    ...
    private Object validateParams(JSONObject params, JSONObject payContext, HttpServletRequest request) {
        ...
        boolean isAllow = YeePayUtil.ipAllow(clintIp, mchInfo.getPayWhiteIp(), mchInfo.getPayBlackIp());
        if(!isAllow) {
...
//            channelUser = openId;
        ...
        OrderCostFeeVO orderCostFeeVO = YeePayUtil.calOrderCostFeeAndIncome(amountL, channelRate, agentRate, parentAgentRate, mchRate);
        // 设置渠道成本及分润
        payOrder.setChannelCost(orderCostFeeVO.getChannelCostFee());
        payOrder.setPlatProfit(orderCostFeeVO.getPlatProfit());
        payOrder.setAgentProfit(orderCostFeeVO.getAgentProfit());
