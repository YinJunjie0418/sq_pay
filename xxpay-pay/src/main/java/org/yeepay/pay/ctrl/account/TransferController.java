...
public class TransferController {
    ...
    public String transfer(@RequestParam String params) {
        ...
        try {
            ...
            if(obj == null) return YeePayUtil.makeRetFail(YeePayUtil.makeRetMap(PayConstant.RETURN_VALUE_FAIL, "账户转账失败", null, PayEnum.ERR_0010.getCode(), "账户转账失败"));
            ...
            if(result != 1) {
                return YeePayUtil.makeRetFail(YeePayUtil.makeRetMap(PayConstant.RETURN_VALUE_FAIL, "支付中心账户转账失败", null, PayEnum.ERR_0010.getCode(), "DB操作失败"));
            }
