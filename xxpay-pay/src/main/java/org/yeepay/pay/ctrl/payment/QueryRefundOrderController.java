...
import org.yeepay.pay.mq.BaseNotify4MchRefund;
import org.yeepay.pay.mq.Mq4MchPayNotify;
import org.yeepay.pay.mq.Mq4MchRefundNotify;
...
public class QueryRefundOrderController extends BaseController {
    ...
    public String queryPayOrder(HttpServletRequest request) {
        ...
        try {
            ...
            if (refundOrder == null) {
                return YeePayUtil.makeRetFail(YeePayUtil.makeRetMap(PayConstant.RETURN_VALUE_FAIL, "退款订单不存在", null, null));
            }
            if(executeNotify &&
