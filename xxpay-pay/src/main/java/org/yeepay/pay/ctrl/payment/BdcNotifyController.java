...
public class BdcNotifyController {
    ...
    public String notify(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        try {
            ...
            // 得到该笔充值商户费用
            Long mchFee = YeePayUtil.getFee((byte) 1, mchInfo.getOffRechargeRate(), null, Long.parseLong(AmountUtil.convertDollar2Cent(inAmount)));
            ...
            if(agentId != null) {
                ...
                if(agentInfo != null && agentInfo.getStatus().equals(MchConstant.PUB_YES)) {
                    ...
                    Long agentFee = YeePayUtil.getFee((byte) 1, inFeeRate, null, Long.parseLong(AmountUtil.convertDollar2Cent(inAmount)));
                    ...
                    if(parentAgentId != null && parentAgentId != 0) {
                        ...
                        if(parentAgentInfo != null && parentAgentInfo.getStatus().equals(MchConstant.PUB_YES)) {
                            ...
                            Long parentAgentFee = YeePayUtil.getFee((byte) 1, parentInFeeRate, null, Long.parseLong(AmountUtil.convertDollar2Cent(inAmount)));
