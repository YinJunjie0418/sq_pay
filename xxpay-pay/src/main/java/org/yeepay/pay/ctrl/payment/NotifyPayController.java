...
import org.yeepay.pay.channel.PayNotifyInterface;
...
public class NotifyPayController {
	...
	public String payNotifyRes(HttpServletRequest request, @PathVariable("channel") String channel) throws ServletException, IOException {
		...
		try {
			...
			_log.error(e, "");
			return YeePayUtil.makeRetFail(YeePayUtil.makeRetMap(PayConstant.RETURN_VALUE_FAIL, "支付渠道类型[channel="+channel+"]实例化异常", null, null));
		}
