...
public class YeePayAgentpayServiceImpl implements IYeePayAgentpayService {

    private static final MyLog _log = MyLog.getLog(YeePayAgentpayServiceImpl.class);
    ...
    Long getFee(MchAgentpayPassage mchAgentpayPassage, Long agentpayAmountL) {
        return YeePayUtil.getFee(mchAgentpayPassage.getMchFeeType(), mchAgentpayPassage.getMchFeeRate(), mchAgentpayPassage.getMchFeeEvery(), agentpayAmountL);
    }
