package org.yeepay.pay.service;
...
import org.yeepay.pay.mq.Mq4TransNotify;
...
public class TransOrderService {
    ...
    public String createTransOrder(JSONObject po) {
        ...
        if(transOrder == null) return YeePayUtil.makeRetFail(YeePayUtil.makeRetMap(PayConstant.RETURN_VALUE_FAIL, "支付中心转账失败", null, null));
        ...
        try{
            ...
            return YeePayUtil.makeRetFail(YeePayUtil.makeRetMap(PayConstant.RETURN_VALUE_FAIL, "支付中心转账失败", null, PayEnum.ERR_0119));
        }
        ...
        if(result != 1) {
            return YeePayUtil.makeRetFail(YeePayUtil.makeRetMap(PayConstant.RETURN_VALUE_FAIL, "创建转账订单失败", null, null));
        }
        // 执行转账
        ...
        if(result != 1) {
            ...
            return YeePayUtil.makeRetFail(YeePayUtil.makeRetMap(PayConstant.RETURN_VALUE_FAIL, "支付中心转账失败", null, PayEnum.ERR_0120));
        }
        ...
        return YeePayUtil.makeRetData(map, transContext.getString("key"));
    }
