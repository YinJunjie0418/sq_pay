...
import org.yeepay.core.service.IYeePayTransService;
...
public class YeePayTransServiceImpl implements IYeePayTransService {

    private static final MyLog _log = MyLog.getLog(YeePayTransServiceImpl.class);
