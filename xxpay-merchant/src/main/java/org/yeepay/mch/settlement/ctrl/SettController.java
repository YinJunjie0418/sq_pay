...
import org.yeepay.core.entity.MchSettBatchRecord;
import org.yeepay.core.entity.SettRecord;
...
public class SettController extends BaseController {
    ...
    public ResponseEntity<?> batchRecordList(HttpServletRequest request) {
        ...
        if(count == 0) ResponseEntity.ok(YeePayPageRes.buildSuccess());
        ...
        return ResponseEntity.ok(YeePayPageRes.buildSuccess(mchSettBatchRecordList, count));
    }
    ...
    public ResponseEntity<?> list(HttpServletRequest request) {
        ...
        return ResponseEntity.ok(YeePayPageRes.buildSuccess(settRecordList, count));
    }
    ...
    public ResponseEntity<?> get(HttpServletRequest request) {
        ...
        return ResponseEntity.ok(YeePayResponse.buildSuccess(settRecord));
    }
