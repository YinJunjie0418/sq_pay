...
import org.yeepay.core.service.IMchPayPassageService;
import org.yeepay.service.dao.mapper.MchPayPassageMapper;
 ...
 * @description: 商户支付通道
 */
@Service(interfaceName = "org.yeepay.core.service.IMchPayPassageService", version = "1.0.0", retries = -1)
