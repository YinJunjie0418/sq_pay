...
public class AgentpayPassageAccountController extends BaseController {
    ...
    public ResponseEntity<?> get(HttpServletRequest request) {
        ...
        return ResponseEntity.ok(YeePayResponse.buildSuccess(agentpayPassageAccount));
    }
    ...
    public ResponseEntity<?> add(HttpServletRequest request) {
        ...
        if(agentpayPassage == null) {
            return ResponseEntity.ok(YeePayResponse.build(RetEnum.RET_MGR_PAY_PASSAGE_NOT_EXIST));
        }
    ...
    public ResponseEntity<?> balance(HttpServletRequest request) {
        ...
        return ResponseEntity.ok(YeePayResponse.buildSuccess(balanceStr));
    }

    String queryBalance(String channelType, String payParam) {
        JSONObject resObj = rpcCommonService.rpcyeepayTransService.queryBalance(channelType, payParam);
        StringBuffer sb = new StringBuffer();
        if(resObj != null && YeePayUtil.isSuccess(resObj)) {
