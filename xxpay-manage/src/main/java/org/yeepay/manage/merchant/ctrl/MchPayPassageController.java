...
public class MchPayPassageController extends BaseController {
    ...
    public ResponseEntity<?> list(HttpServletRequest request) {
        ...
        if(mchInfo == null) {
            return ResponseEntity.ok(YeePayResponse.build(RetEnum.RET_SERVICE_MCH_NOT_EXIST));
        }
    ...
    public ResponseEntity<?> get(HttpServletRequest request) {
        ...
        if(payProduct == null) return ResponseEntity.ok(YeePayResponse.buildSuccess(null));
