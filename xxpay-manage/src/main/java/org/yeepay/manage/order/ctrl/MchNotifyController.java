...
public class MchNotifyController extends BaseController {
    ...
    public ResponseEntity<?> get(HttpServletRequest request) {
        ...
        return ResponseEntity.ok(YeePayResponse.buildSuccess(mchNotify));
    }
    ...
    public ResponseEntity<?> list(HttpServletRequest request) {
        ...
        return ResponseEntity.ok(YeePayPageRes.buildSuccess(mchNotifyList, count));
    }
    ...
    public ResponseEntity<?> resend(HttpServletRequest request) {
        ...
        if(orderIds.size() <= 0 ){
            ...
            return ResponseEntity.ok(YeePayResponse.buildSuccess(resultJSON));
        }
        ...
        for(Object id: orderIds){
            ...
            try {
                ...
                String result = YeePayUtil.call4Post(mchNotify.getNotifyUrl());
