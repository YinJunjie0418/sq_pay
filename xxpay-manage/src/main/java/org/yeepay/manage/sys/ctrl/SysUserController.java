...
import org.yeepay.core.common.util.MyBase64;
...
public class SysUserController extends BaseController {
    ...
    public ResponseEntity<?> list(HttpServletRequest request) {
        ...
        return ResponseEntity.ok(YeePayPageRes.buildSuccess(sysUserList, count));
    }
    ...
    public ResponseEntity<?> viewPermission(HttpServletRequest request) {
        ...
        return ResponseEntity.ok(YeePayResponse.buildSuccess(array));
    }
