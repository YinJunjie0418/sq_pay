...
import org.yeepay.core.entity.SysPermission;
import org.yeepay.core.entity.SysResource;
import org.yeepay.core.entity.SysRole;
import org.yeepay.manage.common.ctrl.BaseController;
import org.yeepay.manage.common.service.RpcCommonService;
import org.yeepay.manage.sys.service.PermTreeBuilder;
...
public class SysRoleController extends BaseController {
    ...
    public ResponseEntity<?> get(HttpServletRequest request) {
        ...
        return ResponseEntity.ok(YeePayResponse.buildSuccess(sysRole));
    }
    ...
    public ResponseEntity<?> list(HttpServletRequest request) {
        ...
        return ResponseEntity.ok(YeePayPageRes.buildSuccess(sysRoleList, count));
    }
    ...
    public ResponseEntity<?> all(HttpServletRequest request) {
        ...
        return ResponseEntity.ok(YeePayResponse.buildSuccess(sysRoleList));
    }
    ...
    public ResponseEntity<?> viewPermission(HttpServletRequest request) {
        ...
        return ResponseEntity.ok(YeePayResponse.buildSuccess(PermTreeBuilder.buildListTree(nodeList)));
    }
