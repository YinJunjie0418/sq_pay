...
import org.yeepay.core.common.domain.MenuTreeBuilder;
...
import org.yeepay.core.entity.SysUser;
import org.yeepay.manage.common.ctrl.BaseController;
import org.yeepay.manage.common.service.RpcCommonService;
import org.yeepay.manage.secruity.JwtAuthenticationRequest;
import org.yeepay.manage.sys.service.SysUserService;
...
public class AuthController extends BaseController {
    ...
    public ResponseEntity<?> current() {
        ...
        return ResponseEntity.ok(YeePayResponse.buildSuccess(sysUser));
    }
    ...
    public ResponseEntity<?> menu(HttpServletRequest request) {
        ...
        return ResponseEntity.ok(YeePayResponse.buildSuccess(JSONArray.parseArray(MenuTreeBuilder.buildTree(nodeList))));
    }
