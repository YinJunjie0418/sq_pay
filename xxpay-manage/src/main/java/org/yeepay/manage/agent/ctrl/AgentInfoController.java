package org.yeepay.manage.agent.ctrl;
...
public class AgentInfoController extends BaseController {
    ...
    public ResponseEntity<?> get(HttpServletRequest request) {
        ...
        return ResponseEntity.ok(YeePayResponse.buildSuccess(agentInfo));
    }
    ...
    public ResponseEntity<?> getParentAgentId(HttpServletRequest request) {
        ...
        return ResponseEntity.ok(YeePayResponse.buildSuccess(list));
    }
    ...
    public ResponseEntity<?> update(HttpServletRequest request) {
        ...
        if(dbAgentInfo == null) {
            return ResponseEntity.ok(YeePayResponse.build(RetEnum.RET_COMM_RECORD_NOT_EXIST));
        }
        ...
        if (agentInfo.getParentAgentId() != null && agentInfo.getParentAgentId() != 0){
            ...
            if (parentAgentInfo == null) return ResponseEntity.ok(YeePayResponse.build(RetEnum.RET_SERVICE_AGENT_NOT_EXIST));
        }
    ...
    public ResponseEntity<?> list(HttpServletRequest request) {
        ...
        return ResponseEntity.ok(YeePayPageRes.buildSuccess(objects, ps, count));
    }
